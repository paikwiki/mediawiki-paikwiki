<?php
/**
 * Paikwiki is based on one of the most popular skin, MonoBook nouveau.
 * 파이킈키 스킨은 인기있는 스킨 중 하나인 모노북 누보 스킨을 기반으로 합니다.
 *
 * @todo document
 * @file
 * @ingroup Skins
 ...
 * @ingroup Skins
 */
class SkinPaikwiki extends SkinTemplate {
	/** Using paikwiki. */
	var $skinname = 'paikwiki', $stylename = 'paikwiki',
		$template = 'PaikwikiTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'paikwiki/main.css', 'screen' );
		if( $wgHandheldStyle ) {
 ...
 * @ingroup Skins
 */
class PaikwikiTemplate extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for Paikwiki skin.
...
<?php		}
		...
		wfRunHooks( 'PaikwikiTemplateToolboxEnd', array( &$this ) );
